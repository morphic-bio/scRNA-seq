...
class OWdownloadURL(OWBwBWidget):
    ...
    inputs = [("directory",str,"handleInputsdirectory"),("trigger",str,"handleInputstrigger"),("URL",str,"handleInputsURL"),("skip",str,"handleInputsskip"),("overwite",str,"handleInputsoverwite")]
    ...
    def handleInputsskip(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsoverwite(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("overwite", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
